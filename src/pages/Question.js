        ...
        <ImageBackground
          ...
          <Card containerStyle={{ borderRadius: 20 }}>
            ...
            <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
              <Text style={styles.textWithShadow}>1</Text>
              <Text style={styles.textWithShadow2}>2</Text>
              <Text style={styles.textWithShadow2}>3</Text>
              <Text style={styles.textWithShadow2}>4</Text>
              <Text style={styles.textWithShadow2}>5</Text>
