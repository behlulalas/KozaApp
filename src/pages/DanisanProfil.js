      ...
      <View style={styles.container}>
        ...
        <ImageBackground
          ...
          <View style={styles.ProfilArea}>
            ...
            <TouchableOpacity style={styles.buton} onPress={() =>navigate('DanisanInfo')}>
            ...
            <TouchableOpacity style={styles.buton}>
              <Text style={styles.text}>Sanal Asistan</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buton} onPress={() =>navigate('HealthInfo')}>
              <Text style={styles.text}>Sağlık Bilgileri</Text>
              <Icon
