        ...
        <ImageBackground
          ...
          <View style={styles.ProfilArea}>
            ...
            <ScrollView style={{width:"100%", paddingTop:"5%"}}>
              <TouchableOpacity style={styles.bilgi}>
                <Text style={{color:"white", padding:"5%"}}>Kan Değerleri</Text>
                <Icon
              ...
              <TouchableOpacity style={styles.bilgi}>
                <Text style={{color:"white", padding:"5%"}}>Yapılması gereken kan tahlilleri</Text>
                
              </TouchableOpacity>
              <TouchableOpacity style={styles.bilgi}>
                <Text style={{color:"white", padding:"5%"}}>Anamnez Formu Anlatımı</Text>
