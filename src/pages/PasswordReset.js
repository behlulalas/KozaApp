    ...
    return (
      <SafeAreaView style={styles.ekran}>
        ...
        <View style={styles.giris}>
          <Text style={styles.yazi}>Lütfen Yeni Parolanızı Giriniz </Text> 
          <View style={styles.kutu }>
            ...
            {this.state.durum2 ? (
              ...
              <TouchableOpacity
              onPress ={()=>this.degistir2()}
              
              >
              <Icon
                  name={this.state.durum2 ? "ios-eye" : 'ios-eye-off'}
                  size={20}
                  color="white"
                  style={styles.gizle} />
              </TouchableOpacity>
